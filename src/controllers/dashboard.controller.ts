...
const SELECT_ALL_LAST_SALE_PRICE =
    "SELECT contract_address, token_id, last_sale_price, last_sale_date FROM last_sale_price WHERE last_sale_date != '-1' OR last_sale_price != '0.00' ORDER BY last_sale_date DESC";
